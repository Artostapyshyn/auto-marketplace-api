...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    	http
    		...
    		.requestMatchers(HttpMethod.GET, "/sellers/**", "/sale-advertisement/**").permitAll()
    		.requestMatchers(HttpMethod.DELETE, "/sellers/**").hasRole(Role.ROLE_ADMIN.name())
    		.requestMatchers(HttpMethod.DELETE, "/sale-advertisement/**").hasAnyRole(Role.ROLE_ADMIN.name(), Role.ROLE_SELLER.name())
    		.anyRequest()
            .permitAll()
            .and()
            .httpBasic()
